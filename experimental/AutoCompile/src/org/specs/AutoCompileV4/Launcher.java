...
package org.specs.AutoCompileV4;
...
import org.specs.AutoCompile.Config;
import org.specs.AutoCompileV4.Job.JobOption;
import org.suikasoft.Jani.SimpleCommandLine.SimpleCommandLine;
...
public class Launcher {
    ...
    public static void main(String[] args) {
       ...
       org.suikasoft.Jani.App autoCompile = buildAutoCompileApp();
       if(autoCompile == null) {
          return;
       }
...
*/
    ...
    * @return
    */
   public static org.suikasoft.Jani.App buildAutoCompileApp() {
      // Load configuration file
      Map<String, AppValue> config = loadConfig();
      if (config == null) {
         LoggingUtils.getLogger().
