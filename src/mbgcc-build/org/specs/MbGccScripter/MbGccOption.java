 ...
 * @author Joao Bispo
 */
public enum MbGccOption implements OptionName {

   flagList("flagList",""),
   optionList("optionList",""),
   inputFoldername("inputFoldername","./"),
   gccMode("mode",GccModes.folderIsProgram.name());

   private MbGccOption(String optionSuffix, String defaultValue) {
   ...
   private static final String OPTION_PREFIX = "mbgcc";
